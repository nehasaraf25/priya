  ...
  return (
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-xl border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        >
          <h1 className="text-3xl font-bold tracking-tighter luxury-font">LŪM</h1>
        </div>

        <nav className="hidden md:flex gap-10 text-[11px] font-bold tracking-[0.2em] uppercase text-gray-400">
          ...
          <a href="#" className="hover:text-black transition-colors">The Vault</a>
        </nav>
        ...
        <div className="flex items-center gap-5">
          ...
          <button 
            onClick={onCartClick}
            className="relative p-1 text-gray-400 hover:text-black transition-colors"
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-5 h-5">
